...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 V2/CrealityV422/ToBeeUI"
...
#define STRING_CONFIG_H_AUTHOR "ToBee" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 V2 24-03-14 Update"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  18.99,  18.99 }
    #define DEFAULT_Ki_LIST {   1.02,   1.02 }
    #define DEFAULT_Kd_LIST {  88.47,  88.47 }
  #else
    // Ender 3 v2
...
#define PIDTEMPBED
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 134.82
  #define DEFAULT_bedKi  25.53
  #define DEFAULT_bedKd 474.55
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define AVOID_OBSTACLES
    ...
    #define CLIP_H  7  // Bed clip height, should be padded a few mm over its physical size

    // Obstacle Rectangles defined as { X1, Y1, X2, Y2 }
    #define OBSTACLE1 { 0,                       0, (X_BED_SIZE), CLIP_H }
    #define OBSTACLE6 { 0, (Y_BED_SIZE) - (CLIP_H), (X_BED_SIZE), Y_BED_SIZE }
